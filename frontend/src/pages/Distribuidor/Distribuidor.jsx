...
//ANT
import { Card as CardAntd, Divider, List, Avatar } from 'antd';
...
import CardInfo from '../Proveedores/Components/CardInfo'
...
const Distribuidor = (props) => {
  ...
  const [dataItem, setDataItem] = useState({
    ...
    noAudito: 150,
    path_img: "1714073566/FRONT_5064850749150929800.jpg",
  ...
  const gridStyle25 = { width: '40%', textAlign: 'center', }
  const gridStyle75 = { width: '60%', textAlign: 'center', }
              ...
              <CardAntd.Grid hoverable={false} style={gridStyle75} >
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={xs} sm={sm} md={md}>
                    <ComponentCard value={70} monto={'14 / 87'} title={'Nacional'} titleValue={'Nacional'} icon={'circle-flags:mx'} />
                  </Grid>

                  <Grid item xs={xs} sm={sm} md={md}>
                    <ComponentCard value={80} monto={'6 / 21'} title={'Zona'} titleValue={'Norte'} icon={'flat-color-icons:puzzle'} />
                  </Grid>

                  <Grid item xs={xs} sm={sm} md={md}>
                    <ComponentCard value={50} monto={'1 / 2'} title={'Estado'} titleValue={'San Luis Potosí'} icon={'flat-color-icons:globe'} />
                  </Grid>

                  <Grid item xs={xs} sm={sm} md={md}>
                    <ComponentCard value={30} monto={'2 / 5'} title={'Grupo'} titleValue={'Torres Corzo'} icon={'flat-color-icons:conference-call'} />
                  </Grid>
